...
const NAV_ITEMS = [
  { id: "home",    iconSrc: HomeIcon,    label: "홈" },
  { id: "explore", iconSrc: MapIcon,     label: "탐색" },
  { id: "book",    iconSrc: BookIcon,    label: "예약" },
  { id: "message", iconSrc: MessageIcon, label: "메시지" },
  { id: "profile", iconSrc: MyPageIcon,  label: "마이페이지" },
];
